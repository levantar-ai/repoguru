  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        {/* Icon */}
        <div className="flex-shrink-0 w-8 h-8 rounded-md flex items-center justify-center" style={{ backgroundColor: `${color}15` }}>
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mt-1">
            ...
            <span className="text-xs text-gray-400 tabular-nums w-7 text-right">{category.score}</span>
          </div>
        </div>
      ...
      <div className="mt-2 flex items-center gap-1 text-[11px] text-gray-500">
        <span className="text-green-500">{foundCount}</span>/<span>{category.signals.length}</span> signals found

...
const CHART_COLORS = [
  ...
  '#facc15', '#22d3ee', '#c084fc', '#4ade80', '#fb7185',
];
...
export function baseOption(overrides: EChartsOption = {}): EChartsOption {
  return {
    ...
    xAxis: { axisLine: { lineStyle: { color: '#334155' } }, splitLine: { lineStyle: { color: '#1e293b' } } },
    yAxis: { axisLine: { lineStyle: { color: '#334155' } }, splitLine: { lineStyle: { color: '#1e293b' } } },
    ...overrides,
  };
}

...
const WEB_TILES: TileDef[] = [
  ...
  { kind: 'git-stats',    title: 'Git Stats',   color: 'text-cyan-400',    description: 'Commits, contributors, ownership, hotspots, heatmaps.',     d: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
  ...
  { kind: 'portfolio',    title: 'Portfolio',   color: 'text-pink-400',    description: 'Profile a developer’s public repos at a glance.',           d: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
  { kind: 'discover',     title: 'Search',      color: 'text-indigo-400',  description: 'Find repositories by topic, language, or stars.',           d: 'M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z' },
  { kind: 'docs',         title: 'Help',        color: 'text-text-muted',  description: 'How RepoGuru works, what each metric means.',               d: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253' },
];
...
function AppContent() {
  ...
  return (
    <div className="flex flex-col h-screen bg-surface text-text bg-gradient-dark">
      ...
      <TabBar iconForKind={iconForKind} colorForKind={colorForKind} rightRail={rightRail} />

...
const DESKTOP_TILES: TileDef[] = [
  ...
  },
  {
    ...
    title: 'Git Stats',
    color: 'text-cyan-400',
    description: 'Every commit, contributor, hotspot, sizer-style stats.',
  ...
  },
  {
    ...
    description: 'Connect GitHub, Anthropic key, theme, AI Enrichment.',
...
const ICON_BY_KIND: Record<string, string> = Object.fromEntries(
  DESKTOP_TILES.map((t) => [t.kind, t.d]),
);
  ...
  return (
    ...
    >
      <CurrentTabProvider tab={tab}>
        {renderTab(tab, { onSendRepoToReportCard })}
      </CurrentTabProvider>
    </div>
  );
}
